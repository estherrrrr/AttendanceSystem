...
public class SchoolCount {
	...
	private static void readFromServer() throws IOException{
		...
		FileOutputStream fos = new FileOutputStream("./src/main/resources/static/download/attendanceResult.txt");
	...
	static class MyMapper extends Mapper<LongWritable,Text,Text,LongWritable>{
		...
		protected void map(LongWritable k1, Text v1, Mapper<LongWritable, Text, Text, LongWritable>.Context context)
			...
			context.write(new Text(splits[3]+"\t"+splits[2]),new LongWritable(1));
			}
		}
